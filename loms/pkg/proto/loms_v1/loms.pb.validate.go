...
// Validate checks the field values on StockAddRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *StockAddRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on StockAddRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// StockAddRequestMultiError, or nil if none found.
func (m *StockAddRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *StockAddRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return StockAddRequestMultiError(errors)
	}

	return nil
}

// StockAddRequestMultiError is an error wrapping multiple validation errors
// returned by StockAddRequest.ValidateAll() if the designated constraints
// aren't met.
type StockAddRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m StockAddRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m StockAddRequestMultiError) AllErrors() []error { return m }

// StockAddRequestValidationError is the validation error returned by
// StockAddRequest.Validate if the designated constraints aren't met.
type StockAddRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e StockAddRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e StockAddRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e StockAddRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e StockAddRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e StockAddRequestValidationError) ErrorName() string { return "StockAddRequestValidationError" }

// Error satisfies the builtin error interface
func (e StockAddRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sStockAddRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = StockAddRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = StockAddRequestValidationError{}

// Validate checks the field values on StockRemoveRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *StockRemoveRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on StockRemoveRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// StockRemoveRequestMultiError, or nil if none found.
func (m *StockRemoveRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *StockRemoveRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return StockRemoveRequestMultiError(errors)
	}

	return nil
}

// StockRemoveRequestMultiError is an error wrapping multiple validation errors
// returned by StockRemoveRequest.ValidateAll() if the designated constraints
// aren't met.
type StockRemoveRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m StockRemoveRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m StockRemoveRequestMultiError) AllErrors() []error { return m }

// StockRemoveRequestValidationError is the validation error returned by
// StockRemoveRequest.Validate if the designated constraints aren't met.
type StockRemoveRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e StockRemoveRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e StockRemoveRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e StockRemoveRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e StockRemoveRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e StockRemoveRequestValidationError) ErrorName() string {
	return "StockRemoveRequestValidationError"
}

// Error satisfies the builtin error interface
func (e StockRemoveRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sStockRemoveRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = StockRemoveRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = StockRemoveRequestValidationError{}
