...
type LomsClient interface {
	...
	StockAdd(ctx context.Context, in *StockAddRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	StockRemove(ctx context.Context, in *StockRemoveRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *lomsClient) CreateOrder(ctx context.Context, in *CreateOrderRequest, opts ...grpc.CallOption) (*CreateOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loms_v1.Loms/CreateOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) ListOrder(ctx context.Context, in *ListOrderRequest, opts ...grpc.CallOption) (*ListOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loms_v1.Loms/ListOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) OrderPayed(ctx context.Context, in *OrderPayedRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/loms_v1.Loms/OrderPayed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) CancelOrder(ctx context.Context, in *CancelOrderRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/loms_v1.Loms/CancelOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) Stocks(ctx context.Context, in *StocksRequest, opts ...grpc.CallOption) (*StocksResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loms_v1.Loms/Stocks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) StockAdd(ctx context.Context, in *StockAddRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/loms_v1.Loms/StockAdd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lomsClient) StockRemove(ctx context.Context, in *StockRemoveRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/loms_v1.Loms/StockRemove", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LomsServer interface {
	...
	StockAdd(context.Context, *StockAddRequest) (*emptypb.Empty, error)
	StockRemove(context.Context, *StockRemoveRequest) (*emptypb.Empty, error)
...
func (UnimplementedLomsServer) StockAdd(context.Context, *StockAddRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StockAdd not implemented")
}
func (UnimplementedLomsServer) StockRemove(context.Context, *StockRemoveRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StockRemove not implemented")
}
...
func _Loms_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loms_v1.Loms/CreateOrder",
	}
...
func _Loms_ListOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loms_v1.Loms/ListOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_OrderPayed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loms_v1.Loms/OrderPayed",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_CancelOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loms_v1.Loms/CancelOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_Stocks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loms_v1.Loms/Stocks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Loms_StockAdd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StockAddRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LomsServer).StockAdd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loms_v1.Loms/StockAdd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LomsServer).StockAdd(ctx, req.(*StockAddRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Loms_StockRemove_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StockRemoveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LomsServer).StockRemove(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loms_v1.Loms/StockRemove",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LomsServer).StockRemove(ctx, req.(*StockRemoveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Loms_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "StockAdd",
			Handler:    _Loms_StockAdd_Handler,
		},
		{
			MethodName: "StockRemove",
			Handler:    _Loms_StockRemove_Handler,
		},
	},
